...
function Calendar({
  ...
  const _monthsClassName = cn("relative flex justify-center w-[17rem]", props.classNames?.months);
  ...
  const _weekdayClassName = cn(
    "w-10 text-lg font-normal text-muted-foreground",
  ...
  const _dayClassName = cn(
    "flex size-10 flex-1 items-center justify-center p-0 text-sm",
